...
const variants = { FillBluegray800: "bg-bluegray_800" };
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#605cff",
              "&:hover": { backgroundColor: "#605cff", color: "#ffffff" },
            }),
...
SelectBox.propTypes = {
  ...
  variant: PropTypes.oneOf(["FillBluegray800"]),
